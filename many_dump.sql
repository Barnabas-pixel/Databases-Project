...
INSERT INTO `CaseFile` VALUES (25642598742541,'Closed','Paige','Williams'),(25681550541255,'Closed','Alex','Johnson'),(75652255265242,'Under-Investigation','Paige','Williams');
...
INSERT INTO `CaseSuspect` VALUES (75652255265242,'Isabella','Smith'),(25681550541255,'John','Roger'),(25642598742541,'Taylor','Cunningham');
...
INSERT INTO `Person` VALUES ('Alex','Johnson'),('Isabella','Smith'),('John','Roger'),('Paige','Williams'),('Taylor','Cunningham');
...
CREATE TABLE `PrimaryOfficer` (
  ...
  PRIMARY KEY (`firstName`,`lastName`),
  CONSTRAINT `fk_officer_person` FOREIGN KEY (`firstName`, `lastName`) REFERENCES `Person` (`firstName`, `lastName`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `Suspect` VALUES ('Isabella','Smith',29),('John','Roger',41),('Taylor','Cunningham',39);
...
-- Dump completed on 2025-11-19 23:21:12
